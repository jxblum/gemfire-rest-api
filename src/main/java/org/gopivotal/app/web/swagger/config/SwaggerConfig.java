...
public class SwaggerConfig {
   ...
   * 3. ..., required to be a Spring bean as Spring will call the postConstruct method to bootstrap Swagger scanning.
   */
  @Bean
  ...
  public ApiListingReferenceScanner apiListingReferenceScanner() {
    ...
    // Picks up all of the registered Spring RequestMappingHandlerMappings during scanning...
