...
public class CustomMappingJackson2HttpMessageConverter extends MappingJackson2HttpMessageConverter {
  ...
  protected void writeInternal(final Object object, final HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
    //System.out.printf("HttpOutMessage Class Type (%1$s)", outputMessage.getClass().getName());
  ...
  protected final class BufferingHttpOutputMessageWrapper implements HttpOutputMessageWrapper {
  ...
  /**
   * @Deprecated While sound idea in theory to "count the bytes as you stream/write", thus preserving memory,
   * this does not work in practice since the HTTP headers must be written to the HTTP output stream response
   * before the body!
   */
  @Deprecated
  protected class ContentLengthAccessibleHttpOutputMessageWrapper implements HttpOutputMessageWrapper {
  ...
  protected final class ByteCountingOutputStream extends OutputStream {
